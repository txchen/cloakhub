...
function dashboardScriptHarness(html: string) {
  ...
  const createTabButtons = [
    fakeDashboardElement({ createTab: "basic" }),
    fakeDashboardElement({ createTab: "browser" }),
    fakeDashboardElement({ createTab: "fingerprint" }),
    fakeDashboardElement({ createTab: "advanced" })
  ];
  const createTabPanels = [
    fakeDashboardElement({ createPanel: "basic" }),
    fakeDashboardElement({ createPanel: "browser" }),
    fakeDashboardElement({ createPanel: "fingerprint" }),
    fakeDashboardElement({ createPanel: "advanced" })
  ];
  ...
  const document = {
    ...
    querySelectorAll: (selector: string) => {
      ...
      if (selector === ".create-tab-button") {
        return createTabButtons;
      }

      if (selector === ".create-tab-panel") {
